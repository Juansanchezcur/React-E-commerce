...
return(
        <div className="Checkout">
            ...
            <form id="formulario">
                ...
                <input type="text"  id="Nombre" onChange={e=>setName(e.target.value)} placeholder="Nombre"/>
                <input type="text"  id="Apellido" onChange={e=>setSurname(e.target.value)} placeholder="Apellido"/>
                <input type="email"  id="Email" onChange={e=>setEmail(e.target.value)} placeholder="E-Mail"/>
                <input type="tel"  id="Teléfono" onChange={e=>setPhone(e.target.value)} placeholder="Teléfono"/>
             
            </form>
            <button className="BotonCarrito"  onClick={createOrder}>Generar Orden</button> 
        </div>   
    )    
